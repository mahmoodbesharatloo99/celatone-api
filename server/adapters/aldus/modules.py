...
class MoveModuleManager:
    def __init__(self, chain: str, network: str):
        """
        Initializes the MoveModuleManager with module data.
        ...
        self.modules = self.load_move_modules(chain, network)

    def load_move_modules(self, chain: str, network: str) -> List[Dict[str, Any]]:
        """
        Fetches module data.
    ...
    def get_move_modules(self) -> List[Dict[str, Any]]:
        """
        Fetches module data.
    ...
    def get_move_module(self, address: str, name: str) -> Dict[str, Any]:
        """
